...
public class UVCCameraHandler extends AbstractUVCCameraHandler {
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent, cameraView, 2, width, height, UVCCamera.FRAME_FORMAT_MJPEG, bandwidthFactor);
	}
	...
	@Override
	public void captureStill(final int deviceId, final OnCaptureListener listener) {
		super.captureStill(deviceId, listener);
	}
}
